...
if configManager.getBoolean(configKeys.VIP_SYSTEM_ENABLED) then
	...
	if vipStayOnline then
		premiumDescription = premiumDescription .. "&#8226; !bank command acess (deposit, withdraw, transfer, balance)\n &#8226; buy bless with command !bless\n &#8226; refill your equips\n &#8226; buy aol with !aol command\n &#8226; stay online idle without getting disconnected\n &#8226; auto-loot items with !autoloot\n&#8226; infinite changegold (right click)"
	end
...
GameStore.Categories = {
	...
	-- Consumables
	{
		...
		name = "Consumables",
		rookgaard = true,
		subclasses = { "Blessings", "Training Weapons", "Potions", "Runes" },
	},
	...
	-- Consumables ~ Runes
	{
		...
		offers = {
			...
			{
				icons = { "Blank rune.png" },
				name = "Blank Rune",
				price = 2,
				itemtype = 3147,
				count = 1000,
				description = "{character}\n{storeinbox}\n{vocationlevelcheck}\n{battlesign}\n{capacity}\n\n<i>A rune used to craft any spells in-game.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
			{
				icons = { "Blank rune.png" },
		...
		offers = {
			{
				...
				itemtype = 3499,
				count = 1,
				description = "<i>A private depot inside your house!</i>\n\n{house}\n{box}\n{storeinbox}\n{usablebyall}\n{info} stock your runes\n{useicon} organize everything\n{backtoinbox}",
				type = GameStore.OfferTypes.OFFER_TYPE_HOUSE,
			},
			{
	...
	-- Boost
	{
		...
		offers = {
			...
			},
			{
				...
				count = 1,
				itemtype = 36725,
				description = "<i>Purchase a boost that recovers 2h of your stamina",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
			},
		},
	},
